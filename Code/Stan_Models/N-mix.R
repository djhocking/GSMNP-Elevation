...
source("Code/Stan_Models/N-mix-Data.R")
...
out <- stan("Code/Stan_Models/N-mix.stan",
...
print(out, digits = 3)
plot(out, par = c("alpha0", "alpha1", "beta0", "beta1"))
traceplot(out, par = c("alpha0", "alpha1", "beta0", "beta1"))
